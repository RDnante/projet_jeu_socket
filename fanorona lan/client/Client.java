...
public class Client {
    ...
    public void init(ObjectInputStream out) throws Exception {
        String donnee = (String) out.readObject();
        System.out.println(donnee);

        this.string_table(donnee, this.getJeu());
    }
    ...
    public void string_table(String donne, Table t) {
        ...
        if(val[val.length -1].equals("nandresy") == true || val[val.length -1].equals("resy") == true){
            t.setEncours(0);
            System.out.println("adf 1");
            if (val[val.length -2].equals("nandresy")) {
                System.out.println("nandresy");
